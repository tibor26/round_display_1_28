...
GLOBAL volatile uint32_t nTimeOutCnt = 0;

GLOBAL volatile bool sysTickFlag1mS  = false;
GLOBAL volatile bool sysTickFlag     = false;
GLOBAL volatile u32  sysTickCnt      = 0;
...
GLOBAL volatile bool sysTickFlag1mS;
GLOBAL volatile uint32_t nTimeOutCnt;
GLOBAL volatile bool sysTickFlag;
GLOBAL volatile u32 sysTickCnt;
